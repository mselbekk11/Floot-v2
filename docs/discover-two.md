I want to try out a second type of discover section 

please create inside of /Users/morgan/projects/floot/components/discover-two.tsx

please look at what i currenrlt have - i want to pull the same data, i just want it to look like the above.

when done comment out the old one and put this one in instead 
